...
//      GitHub：https://github.com/kingsic/SGPagesView
//
//  SGPageTitleView.m
//  SGPagesViewExample
//
...
- (instancetype)initWithFrame:(CGRect)frame delegate:(id<SGPageTitleViewDelegate>)delegate titleNames:(NSArray *)titleNames configure:(SGPageTitleViewConfigure *)configure {
    if (self = [super initWithFrame:frame]) {
        ...
        if (delegate == nil) {
            @throw [NSException exceptionWithName:@"SGPagesView" reason:@"SGPageTitleView 的代理方法必须设置" userInfo:nil];
        }
        self.delegatePageTitleView = delegate;
        if (titleNames == nil) {
            @throw [NSException exceptionWithName:@"SGPagesView" reason:@"SGPageTitleView 的标题数组必须设置" userInfo:nil];
        }
        self.titleArr = titleNames;
        if (configure == nil) {
            @throw [NSException exceptionWithName:@"SGPagesView" reason:@"SGPageTitleView 的配置属性必须设置" userInfo:nil];
        }
